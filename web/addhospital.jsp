<%-- 
    ...
    Created on : 17-Mar-2024, 12:25:29 pm
    Author     : rhita
--%>
...
<html>
    ...
    <body>
        ...
        <table align="center">
            ...
            <tr>
             ...
             <tr>
                <td>
                    <input type="text" name="hm" placeholder="Enter Hospital mail id " required />
                </td>
            </tr>
            <tr>
                <td>
	...
	String ins="insert into addhospital(hospitalname,haddress,hcity,hcontact,hmail) values(?,?,?,?,?)";
